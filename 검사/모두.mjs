...
const 목록 = [
  ...
  ['게이트',        51, '등록·제안·접수의 문턱 - 무엇이 열고 무엇이 막는가'],
  ['호',            16, '호수는 손님에게 가지 않는다 (동은 간다)'],
  ['동의',          31, '필수·선택을 가르고 **언제** 동의했는지를 남긴다'],
  ['광고',          33, '표시·광고 명시사항이 손님 화면까지 닿는가'],
  ['가입',          47, '파트너 자격 - 손님 조건 전문이 걸린 문. 서버가 직접 대조한다'],
  ['연락처',        24, '연결을 누르기 전에는 양쪽 다 연락처가 안 오간다'],
  ['문',            28, '운영 화면과 본인확인 - 누가 들어올 수 있는가'],
  ['돌아올주소',    23, '네이버 로그인이 돌아올 주소 - 세션이 실려 온다'],
